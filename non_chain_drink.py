...
def drink2_func():
    ...
    output_message4 = text_reply.text_reply_message(f"{drink2}地圖位置")
    output_message5 = LocationSendMessage(
        title = f"{drink2}",
...
def drink3_func():
    ...
    output_message4 = text_reply.text_reply_message(f"{drink3}地圖位置")
    output_message5 = LocationSendMessage(
        title = f"{drink3}",
        address = "台南市東區勝利路58號",
...
def drink4_func():
    ...
    output_message4 = text_reply.text_reply_message(f"{drink4}地圖位置")
    output_message5 = LocationSendMessage(
        title = f"{drink4}",
...
def drink5_func():
    ...
    output_message4 = text_reply.text_reply_message(f"{drink5}地圖位置")
    output_message5 = LocationSendMessage(
        title = f"{drink5}",
...
def drink6_func():
    ...
    output_message4 = text_reply.text_reply_message(f"{drink6}地圖位置")
    output_message5 = LocationSendMessage(
        title = f"{drink6}",
...
def drink7_func():
    ...
    output_message4 = text_reply.text_reply_message(f"{drink7}地圖位置")
    output_message5 = LocationSendMessage(
        title = f"{drink7}",
...
def drink8_func():
    ...
    output_message4 = text_reply.text_reply_message(f"{drink8}地圖位置")
    output_message5 = LocationSendMessage(
        title = f"{drink8}",
