    ...
    if msg_type == "sticker":
        ...
        if user_message == "可樂": 
            ...
            output_message = ImageSendMessage(
                original_content_url = "https://etaiwan.blog/wp-content/uploads/20230712074403_19.jpg",
                preview_image_url = "https://etaiwan.blog/wp-content/uploads/20230712074403_19.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        #咖啡廳
            ...
            reply_arr = []
            output_message1 = text_reply.text_reply_message("點選圖片即可獲取資訊！")
        ...
        # 1. 圖片網址 -> 第8行
        # 2. 標題名稱 -> 第16行
        # 3. 星星數(如果不一樣) -> 第48行 and 第52行
        # 4. 地址 -> 第84行
        # 5. 營業時間 -> 第117行
        # 6. 限時與否 and wifi -> 第149行 and 第186行
        # 7. 菜單訊息 -> 第210行
