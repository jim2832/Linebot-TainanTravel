...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        elif user_message == "圖片1":
            output_message = ImageSendMessage(
                original_content_url = "https://candicecity.com/wp-content/uploads/2019/07/P4144607.jpg",
                preview_image_url = "https://candicecity.com/wp-content/uploads/2019/07/P4144607.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)

        elif user_message == "圖片2":
            output_message = ImageSendMessage(
                original_content_url = "https://www.yummyday.com.tw/upload/v6/0l6/36474de699494ed297b85dcfeb29a737.jpg",
                preview_image_url = "https://www.yummyday.com.tw/upload/v6/0l6/36474de699494ed297b85dcfeb29a737.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)

        elif user_message == "圖片3":
            output_message = ImageSendMessage(
                original_content_url = "https://s3-us-west-1.amazonaws.com/pic.2bite.com/event/5e98461c5b4d047cdc229217/cover/b02ce95107414327b274c32208dc4735.jpg",
                preview_image_url = "https://s3-us-west-1.amazonaws.com/pic.2bite.com/event/5e98461c5b4d047cdc229217/cover/b02ce95107414327b274c32208dc4735.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)

        elif user_message == "圖片4":
            output_message = ImageSendMessage(
                original_content_url = "https://img.rainieis.tw/uploads/20200330233358_12.jpg",
                preview_image_url = "https://img.rainieis.tw/uploads/20200330233358_12.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)

        elif user_message == "圖片5":
            output_message = ImageSendMessage(
                original_content_url = "https://4.bp.blogspot.com/-fXC5rl_Dtx4/XilfkEbLc3I/AAAAAAAAJzQ/3GMFUUz9oFMmkn1U7ArJb5DlzaPzM8UYwCKgBGAsYHg/s1600/IMG_0997.jpg",
                preview_image_url = "https://4.bp.blogspot.com/-fXC5rl_Dtx4/XilfkEbLc3I/AAAAAAAAJzQ/3GMFUUz9oFMmkn1U7ArJb5DlzaPzM8UYwCKgBGAsYHg/s1600/IMG_0997.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)

        elif user_message == "圖片6":
            output_message = ImageSendMessage(
                original_content_url = "https://img.ltn.com.tw/Upload/playing/page/2020/03/05/200305-19193-1-5OuGz.jpg",
                preview_image_url = "https://img.ltn.com.tw/Upload/playing/page/2020/03/05/200305-19193-1-5OuGz.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)
        
        elif user_message == "圖片7":
            output_message = ImageSendMessage(
                original_content_url = "https://pic.pimg.tw/imsean/1469108135-953791719.jpg",
                preview_image_url = "https://pic.pimg.tw/imsean/1469108135-953791719.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)

        elif user_message == "圖片8":
            output_message = ImageSendMessage(
                original_content_url = "https://cdn.walkerland.com.tw/images/upload/poi/p952/m46619/51c5125714ad81f6c457f4214d0906270c98d83b.jpg",
                preview_image_url = "https://cdn.walkerland.com.tw/images/upload/poi/p952/m46619/51c5125714ad81f6c457f4214d0906270c98d83b.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)

        elif user_message == "圖片9":
            output_message = ImageSendMessage(
                original_content_url = "https://img.rainieis.tw/uploads/20180816160442_76.jpg",
                preview_image_url = "https://img.rainieis.tw/uploads/20180816160442_76.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)

        elif user_message == "圖片10":
            output_message = ImageSendMessage(
                original_content_url = "http://2.bp.blogspot.com/_UA6xx1hhCsQ/SYaaanQbucI/AAAAAAAABas/boIKMS6X0AI/s280/zhous+shrimp+roll.jpg",
                preview_image_url = "http://2.bp.blogspot.com/_UA6xx1hhCsQ/SYaaanQbucI/AAAAAAAABas/boIKMS6X0AI/s280/zhous+shrimp+roll.jpg"
            )
            line_bot_api.reply_message(event.reply_token, output_message)
